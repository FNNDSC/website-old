...
beforetoc: "TThe main items of discussion during this meeting were using the fnndsc.childrens server for the hackathon and making it more persistent, optimizing file ops that occur within swift, and the node parameter config UI."
toc: true
categories: [ status ]
